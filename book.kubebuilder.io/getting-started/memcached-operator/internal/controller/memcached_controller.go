...
import (
	...
	cachev1alpha1 "go.jlucktay.dev/kubernetes-workbench/book.kubebuilder.io/getting-started/memcached-operator/api/v1alpha1"
)
...
const (
	...
	// typeDegradedMemcached represents the status used when the custom resource is deleted and the finalizer operations
	// are yet to occur.
	typeDegradedMemcached = "Degraded" //nolint:unused
)
...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	meta.SetStatusCondition(&memcached.Status.Conditions, metav1.Condition{
		...
		Message: fmt.Sprintf("Deployment for custom resource (%s) with %d replicas created successfully",
			memcached.Name, size),
	})
